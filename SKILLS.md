...
### Abilities
1. ⬇️ Light Fall: Reduces fall damage
2. 👟 Runner: Gives half vanilla xp per skill xp earned [modified]
3. ⬆️ Jumper: Increases jump height
4. 🤻 Fleeting: Increases movement speed when below a certain health percentage
5. 🥕 Meal Steal: Steals hunger from players & living mobs [modified]

## ⚗️ Alchemy
The alchemy skill gives bonuses to potions, revolves around generation of vanilla XP
### Abilities
1. ⚗️ Brewer: Increases drunk potion duration [modified]
...
2. 🎯 Archer: Gives half vanilla xp per skill xp earned [modified]
3. 🏹 Bow Master: Increases bow damage
4. 💘 Piercing: Chance for arrows to pierce through targets
5. ♻️ Infinity: Chance to immediately recover any arrow shot [modified]

## 🛡️ Defense
The defense skill gives bonuses to damage reduction and survivability
### Abilities
1. 🛡️ Shielding: Reduces all damage taken
2. 🏰 Defender: Gives half vanilla xp per skill xp earned [modified]
3. 👥 Mob Master: Reduces damage taken from mobs
4. ✳️ Immunity: Chance to dodge attacks completely
...
2. Excavator: Gives half vanilla xp per skill xp earned [modified]
3. Spade Master: Increases shovel damage
...
2. Farmer: Gives half vanilla xp per skill xp earned [modified]
3. Scythe Master: Increases hoe damage
...
2. Fighter: Gives half vanilla xp per skill xp earned [modified]
3. Sword Master: Increases sword damage
...
2. ⚒️ Miner: Gives half vanilla xp per skill xp earned [modified]
3. ⛏️ Pick Master: Increases pickaxe damage
